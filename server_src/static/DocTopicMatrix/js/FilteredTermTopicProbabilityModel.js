...
FilteredTermTopicProbabilityModel.prototype.load = function() {
	...
	var successHandler = function(model, response, options) {
		console.log("Loaded FilteredTermTopicProbabilityModel 0703", model, response, options);
		...
		initRowIndexMap( this.parentModel.get("docIndex") );
	...
	var errorHandler = function(model, response, options) {
		console.log("Cannot load FilteredTermTopicProbabilityModel 0703", model, response, options);
	}.bind(this);
	this.fetch({
		add : false,
...
FilteredTermTopicProbabilityModel.prototype.filter = function( ) {
	...
	var original_termIndex = this.parentModel.get("docIndex");
